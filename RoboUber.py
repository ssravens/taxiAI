...
worldY = 50
runTime = 1440
# change the DisplaySize to be bigger if you want larger-size objects on-screen
displaySize = (1024, 768)
trafficOn = False

# play around with these parameters to see how they affect the results.
...
def runRoboUber(worldX, worldY, runTime, junctions=None, streets=None, interpolate=False, outputValues=None, **args):
